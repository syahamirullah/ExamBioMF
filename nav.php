...
<polygon class="st0" points="60.1,260.3 167.4,341 180.4,380.3 "/>
		...
		<h1 class="brand brand-name navbar-left"><div class"navbar-left">SKPMBCJ</h1>
        </div>
        <div class="collapse navbar-collapse navbar-right" id="myNavbar">
            <ul class="nav navbar-nav">
                <li><a href="daftarpengguna.php">Daftar Pengguna</a></li>
   				<li><a href="daftar.php">Daftar Pelajar</a></li>
   				<li><a href="peperiksaan.php">Peperiksaan</a></li>
    			<li><a href="kehadiran.php">Penjanaan Kehadiran</a></li>
                <li><a href="#log">Log Keluar</a></li>
            </ul>
        </div>
    </div>
</nav>
