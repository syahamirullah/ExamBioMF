  ...
  if(daftar_pengguna($_POST)>0){
    ...
    echo "
        <script>
          ...
          document.location.href='daftarpengguna.php';
        </script>
    ";
  }
}
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="Idstaff">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="password" name="KataLaluan">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="fakulti">
                                            <option disabled="disabled" selected="selected">Pilih Fakulti Diwakili</option>
